    ...
    public String authenticate() {
         try {
            ...
            try (CloseableHttpClient httpClient = HttpClients.custom()
                 ...
                 HttpPost httpPost = new HttpPost(AuthRequestValue.E_SINTAXE.getValue()+"rest/users/auth");
                httpPost.setHeader("Content-Type", "application/x-www-form-urlencoded");


                List<BasicNameValuePair> form = new ArrayList<>();
                form.add(new BasicNameValuePair("form[email]", AuthRequestValue.ASF_AUTH_EMAIL.getValue()));
                form.add(new BasicNameValuePair("form[password]", AuthRequestValue.ASF_AUTH_PASSWORD.getValue()));
